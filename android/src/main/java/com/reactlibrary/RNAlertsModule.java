...
public class RNAlertsModule extends ReactContextBaseJavaModule {
  ...
  public Map<String, Object> getConstants() {
    final Map<String, int> constants = new HashMap<>();
  ...
  @ReactMethod
  public void alert(String message, Promise promise) {
  ...
  @ReactMethod
  public void alert(String title, String message, Promise promise) {
    AlertDialog.Builder builder = new AlertDialog.Builder(reactContext);
  ...
  @ReactMethod
  public void alert(String title, String message, String button, Promise promise) {
    AlertDialog.Builder builder = new AlertDialog.Builder(reactContext);
    builder.setTitle(title);
    builder.setMessage(message);
